...
- Vocabulary: task status is backlog | todo | planning | in_progress | in_review | blocked | done | cancelled | parked (projects/epics default working; tasks default todo). 'planning' means an unblock-planning council is active; 'in_review' means implementation exists and is being verified. Priority is p0–p4 or critical/high/medium/low (default p2). Closed = done/cancelled/parked. Soft-archive only.
