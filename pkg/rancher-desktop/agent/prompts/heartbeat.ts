...
- Use tools — exec, fs, docker, N8n-Workflows, git, playwright (browser_tab, browse_page, synthesize_tabs, click_element, etc.), memory, calendar, projects, skills, bridge
