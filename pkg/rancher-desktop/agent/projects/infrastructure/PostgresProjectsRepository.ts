...
export class PostgresProjectsRepository implements ProjectsRepository {
  constructor(private readonly unitOfWork: ProjectsUnitOfWork = new PostgresProjectsUnitOfWork()) {}
  ...
  updateTask(id: string, changes: UpdateTaskInput) { return this.unitOfWork.updateTaskAtomically(id, changes) }
