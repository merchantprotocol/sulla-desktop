/**
 * readability-extract.ts
 *
 * Migrated from OpenClaw's web-fetch-utils.ts.
 * Provides high-quality content extraction using Mozilla Readability + linkedom.
 * Falls back to regex-based HTML-to-Markdown when Readability is unavailable.
 */
...
/**
 * Extract readable content from raw HTML using Mozilla Readability.
