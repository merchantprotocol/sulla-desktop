import { buildWorkReport } from '../../prompts/workReport';
 ...
 * the orchestrating agent's first run (see prompts/workReport.ts).
 */
export class WorkReportWorker extends BaseTool {
  name = '';
  description = '';
