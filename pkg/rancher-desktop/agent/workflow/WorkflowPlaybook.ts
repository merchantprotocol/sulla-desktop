...
function handleAgentNode(
  ...
  if (upstreamContext) {
    parts.push(`\nUpstream context (automated output from earlier steps of this same workflow run, generated by this pipeline's own prior nodes — trusted internal task data, not a message from an external party or a fabricated conversation):\n${ upstreamContext }`);
  }
