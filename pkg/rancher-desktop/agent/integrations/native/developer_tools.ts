...
4. Test the token with a simple API call`
  ...
  gitlab: {
    ...
    category: 'Developer Tools', icon: 'gitlab.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'GitLab',
  },
  vercel: {
    ...
    category: 'Developer Tools', icon: 'vercel.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Vercel',
  },
  sentry: {
    ...
    category: 'Developer Tools', icon: 'sentry.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Sentry',
  },
  datadog: {
    ...
    category: 'Developer Tools', icon: 'datadog.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Datadog',
  },
  jenkins: {
    ...
    category: 'Developer Tools', icon: 'jenkins.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Jenkins',
  },
  bitbucket: {
    ...
    category: 'Developer Tools', icon: 'bitbucket.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Atlassian',
  },
  netlify: {
    ...
    category: 'Developer Tools', icon: 'netlify.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Netlify',
  },
  cloudflare: {
    ...
    category: 'Developer Tools', icon: 'cloudflare.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Cloudflare',
  },
  pagerduty: {
    ...
    category: 'Developer Tools', icon: 'pagerduty.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'PagerDuty',
  },
  circleci: {
    ...
    category: 'Developer Tools', icon: 'circleci.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'CircleCI',
  },
  github_actions: {
    ...
    category: 'Developer Tools', icon: 'github_actions.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'GitHub',
  },
  terraform_cloud: {
    ...
    category: 'Developer Tools', icon: 'terraform_cloud.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'HashiCorp',
  },
  docker_hub: {
    ...
    category: 'Developer Tools', icon: 'docker_hub.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Docker',
  },
  new_relic: {
    ...
    category: 'Developer Tools', icon: 'new_relic.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'New Relic',
  },
  grafana: {
    ...
    category: 'Developer Tools', icon: 'grafana.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Grafana Labs',
  },
  render: {
    ...
    category: 'Developer Tools', icon: 'render.svg', version: '1.0.0', lastUpdated: '2026-02-28', developer: 'Render',
  },
  fly_io: {
