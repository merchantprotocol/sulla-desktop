...
export const nativeAiInfrastructureIntegrations: Record<string, Integration> = {
  ...
  enterprise_sulla: {
    ...
    beta:        true,
    comingSoon:  false,
    name:        'Enterprise Sulla',
    description: 'Route voice transcription and speech through the Enterprise Gateway instead of calling ElevenLabs directly.',
    category:    'AI Infrastructure',
    icon:        'custom.svg',
    connected:   false,
    version:     '1.0.0',
    lastUpdated: '2026-03-20 00:00:00',
    developer:   'Merchant Protocol',
    formGuide:   'Enter your Enterprise Gateway URL and API key. Grab the API key from the gateway dashboard.',
    properties:  [
      {
        key:         'gateway_url',
        title:       'Gateway URL',
        hint:        'The base URL of your Enterprise Gateway (e.g. https://gateway.example.com).',
        type:        'url',
        required:    true,
