  ...
  validateSettings(
    ...
    this.allowedSettings ||= {
      ...
      experimental: {
        ...
        externalWaitMonitorEnabled: this.checkBoolean,
        externalWaitCommentSuppressionEnabled: this.checkBoolean,
        externalWaitMonitorConcurrency: this.checkNumber(1, 32),
