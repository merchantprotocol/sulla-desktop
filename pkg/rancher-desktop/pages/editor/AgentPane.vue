          ...
          <div class="agent-row-wrapper">
            ...
            <div class="agent-menu-anchor">
              ...
              >
                ...
                <button
                  class="agent-dropdown-item danger"
                  :class="{ dark: isDark }"
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <path
                    v-if="expandedDirs.has(entry.path)"
      ...
      >
        ...
        >
          ...
          <div class="agent-confirm-actions">
            ...
            <button
              class="agent-confirm-btn delete"
              :disabled="deleting"
              @click="doDelete"
            >
