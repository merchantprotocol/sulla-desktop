  ...
  <header class="sticky top-0 z-50 flex flex-none items-center justify-between bg-page pl-20 pr-4 py-4 shadow-md transition duration-500 backdrop-blur-sm sm:pr-6 lg:pr-8 app-titlebar">
    ...
    <div class="relative flex basis-0 justify-end items-center gap-4">
      <div v-if="route.path === '/Filesystem'" class="flex gap-2">
        ...
        >
          <svg aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" class="h-3.5 w-3.5">
      ...
      <div class="relative z-10">
        ...
        <button
          ...
          @click="toggleTheme"
        >
          <svg v-if="isDark" aria-hidden="true" viewBox="0 0 16 16" class="h-3.5 w-3.5 fill-sky-400">
          ...
          <svg v-else aria-hidden="true" viewBox="0 0 16 16" class="h-3.5 w-3.5 fill-sky-400">
