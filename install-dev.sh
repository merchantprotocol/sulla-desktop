...
# ============================================================================
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/merchantprotocol/sulla-desktop/main/install-dev.sh | bash
#
# Install nightly (latest from main, may be unstable):
#   curl -fsSL https://raw.githubusercontent.com/merchantprotocol/sulla-desktop/main/install-dev.sh | bash -s -- --nightly
#
# Or if you already cloned the repo:
#   bash install-dev.sh
#   bash install-dev.sh --nightly
#
# Options:
